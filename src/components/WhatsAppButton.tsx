const WHATSAPP_NUMBER = '923178600056';
const DEFAULT_MESSAGE = 'Assalam o Alaikum! Mujhe DigitX Pro products ke baare mein maloomat chahiye.';
...
export function openWhatsApp(
  ...
  const webUrl = getWhatsAppUrl(message);
  const appUrl = `whatsapp://send?phone=${WHATSAPP_NUMBER}&text=${encodeURIComponent(message)}`;

  // For checkout / forms: keep the current page open and launch WhatsApp.
  if (keepPage) {
    if (isMobileDevice()) {
...
export const whatsappDisplayNumber = '0317 8600056';
